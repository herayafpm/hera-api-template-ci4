...
{
    protected $table                = 'hera_user_group';
    ...
    {
        return $this->select("{$this->table}.*,group.nama")->join("hera_group", "{$this->table}.group_id = hera_group.id", "LEFT")->where(['username' => $username])->findAll();
    }
    ...
    public function filter($limit, $start, $order, $ordered, $params = [])
	{
        ...
        if(isset($params['select'])){
            ...
            $builder->select("DISTINCT(username) as username");
        }
